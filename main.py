...
if __name__ == '__main__':
  r = Raytracer(500, 500)
  r.light = Light(V3(0.5, -0.5, 2), 1.1, color(250, 191, 30, normalized=False))
  r.bg_color = color(135, 206, 255, normalized=False)

  grass = Material(color(0, 1, 0), [0.9, 0.1, 0, 0], 40)
  white_wood = Material(color(230, 230, 230, normalized=False), [0.85, 0.1, 0.05, 0], 10)
  ...
  light_wood = Material(color(237, 185, 88, normalized=False), [0.75, 0.15, 0.1, 0], 50)
  fire = Material(color(255, 130, 30, normalized=False), [0.8, 0.15, 0, 0.05], 10, 1)

  Tree1 = [
    # Wood
    Cube(V3(1, 0.1, -4), (0.6, 1.4, 0.6), white_wood),
  ...
  stairs = [
    Cube(V3(0, 1.4, -4), (1.2, 0.4, 0.4), light_wood),    
    Cube(V3(0, 1.45, -3.5), (1.2, 0.4, 0.4), light_wood),
    Cube(V3(0, 1.55, -3), (1.2, 0.4, 0.4), light_wood),
  ]

  torchs = [
    Cube(V3(0.3, 0.5 - 0.08, -2.5), (0.08, 0.08*3, 0.08), light_wood),
